run command:
#不带附件
java -cp /data/production/ToolCommon/sendmailudf:/data/production/ToolCommon/sendmailudf/* com.ipinyou.sendmail.Send "title:测试发送邮件" "这是正文内容,can u see?"  yangchun.sheng@ipinyou.com
